...
public class LoginController implements ActivationConstant {
    ...
    public String register(Model model, User user) {
        Map<String, Object> mp = userService.register(user);
        ...
        model.addAttribute("usernameMsg", mp.get("usernameMsg"));
        model.addAttribute("passwordMsg", mp.get("passwordMsg"));
        model.addAttribute("emailMsg", mp.get("emailMsg"));
        return "/site/register";
    }
    ...
    public String login(String username, String password, String code, boolean remember,
        ...
        Map<String, Object> mp = userService.login(username, password, expiredSeconds);
